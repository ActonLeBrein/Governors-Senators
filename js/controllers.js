...
uniApp.controller('indexCtrl', function($scope, $filter, uniFactory) {
	...
	$scope.check_puesto_1 = function() {
		if ($scope.gobernador_seleccionado.opcandidate1pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_2 = function() {
		if ($scope.gobernador_seleccionado.opcandidate2pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_3 = function() {
		if ($scope.gobernador_seleccionado.opcandidate3pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_4 = function() {
		if ($scope.gobernador_seleccionado.opcandidate4pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_5 = function() {
		if ($scope.gobernador_seleccionado.opcandidate5pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_6 = function() {
		if ($scope.gobernador_seleccionado.opcandidate6pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_7 = function() {
		if ($scope.gobernador_seleccionado.opcandidate7pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.check_puesto_8 = function() {
		if ($scope.gobernador_seleccionado.opcandidate8pastjob_e != '') {
			return true;
		}
		else {
			return false;
	...
	$scope.getParty2 = function(p){
		...
		if (p == "Peace and Freedom")
			return "Paz y Libertad";
		if (p == "Liberty Union Party")
			return "Unión del Partido Libertador";
		if (p == "United Citizens Party")
			return "Partido de los Ciudadanos Unidos";
		if (p == "Moderate Party")
			return "Partido Moderado";
		if (p == "Compassion Party")
			return "Partido de la Compasión";
	}
